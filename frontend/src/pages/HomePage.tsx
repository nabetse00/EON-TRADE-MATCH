            ...
            <Card style={{ width: "550px" }} title={`Eon Trade Match`} >
                ...
                <Card.Grid style={gridStyle}>
                    ...
                    <Paragraph>
                        ...
                        Welcome to EonTrade Match, the premier platform for automated trades between users without the need for a direct counterparty.
                    ...
                    <Paragraph>
                        Experience a new era of automated trading with EonTrade Match. Join our community of traders, eliminate the hassle of finding a direct counterparty, 
                        and unlock the full potential of your assets. Embrace the future of trading with EonTrade Match– where seamless and secure transactions become a reality.
                    </Paragraph>
                </Card.Grid>
